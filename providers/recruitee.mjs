...
// NaN-safe Date.parse — `|| undefined` would also coerce valid epoch 0.
...
export function parseRecruiteeResponse(json, companyName) {
  ...
  return offers.map(j => {
    ...
    return {
      ...
      location,
      company: companyName,
      // "2026-07-14 07:03:25 UTC" — V8 Date.parse handles this legacy format
      postedAt: toEpochMs(j.published_at ?? j.created_at),
    };
  });
}
