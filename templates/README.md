...
System-layer template files used by snipe scripts and modes -- put user customizations in the user-layer files instead (see the data contract in CLAUDE.md).
...
| `states.yml` | `tracker/verify-pipeline.mjs`, `tracker/normalize-statuses.mjs`, `tracker/merge-tracker.mjs` | Canonical application states and their aliases |
...
**Customization:** Edit this file to change colors, spacing, or section order. The placeholder tokens are documented in `batch/local-tailor-prompt.md`.
